 ...
 * a RecyclerView. RecyclerView uses a NoFlashItemAnimator by default.
 *
 * @see RecyclerView.setItemAnimator
 */
class NoFlashItemAnimator : SimpleItemAnimator() {
    ...
    override fun animateMove(
        holder: RecyclerView.ViewHolder, fromX_: Int, fromY_: Int,
        toX: Int, toY: Int
    ): Boolean {
        var fromX = fromX_
        var fromY = fromY_
...
//        val oldHolder
     ...
     *
     *
     * If the payload list is not empty, NoFlashItemAnimator returns `true`.
     ...
     * then NoFlashItemAnimator will call [.animateMove] and
