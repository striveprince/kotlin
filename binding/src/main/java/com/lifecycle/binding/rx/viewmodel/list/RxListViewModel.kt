package com.lifecycle.binding.rx.viewmodel.list
...
open class RxListViewModel<E : Inflate>(val adapter: IRxListAdapter<E> = RxRecyclerAdapter()) :
    RxLifeViewModel(), IRxListAdapter<E>, Observer<MutableList<E>> {
    var pageWay = true
    var pageCount = 10
    var headIndex = 0
    var offset = 0
