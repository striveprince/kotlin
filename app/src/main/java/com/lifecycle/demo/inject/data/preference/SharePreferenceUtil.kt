...
//            }
     ...
     * instanceof Set ,but It isn'model instanceof Set<String>,this will throw activity_video ClassCastException;
     *
     * @param key   key
     * @param value value
    </String></String> */
        ...
        try {
            ...
            throw RuntimeException(
                "please check the construct of the " + clazz.name +
                        ", \tthe class of construct must be have activity_video no parameter ", e
            )
        }
